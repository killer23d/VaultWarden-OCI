...
* **Unified Libraries**: 5 shared libraries (common, Docker, crypto, security, backup\_utils) for consistent functionality  
...
\# 1\. Clone and prepare  
git clone \[https://github.com/killer23d/VaultWarden-OCI.git\](https://github.com/killer23d/VaultWarden-OCI.git)  
cd VaultWarden-OCI  
chmod \+x \*.sh
...
\# 3\. Configure secrets (CRITICAL \- set admin\_basic\_auth\_hash and API tokens)  
./edit-secrets.sh

\# 4\. Configure environment (.env file \- set CLOUDFLARE\_ZONE\_ID, etc.)  
nano .env
...
└── lib/  
    ...
    └── backup\_utils.sh                \# Backup-specific utilities
...
\# Create two API tokens at \[https://dash.cloudflare.com/profile/api-tokens\](https://dash.cloudflare.com/profile/api-tokens)  
...
nano .env  
\# Set: CLOUDFLARE\_ZONE\_ID, RCLONE\_REMOTE\_NAME, etc.

4. **Secrets Configuration**:

\# Securely edit secrets  
./edit-secrets.sh  
\# Set: admin\_basic\_auth\_hash, caddy\_cloudflare\_dns\_token, fail2ban\_cloudflare\_firewall\_token  
...
nano .env  
\# Set: SMTP\_HOST, SMTP\_PORT, SMTP\_USERNAME, etc.
...
\# Navigate to: \[https://vault.yourdomain.com/admin\](https://vault.yourdomain.com/admin) → SMTP Settings → Send Test Email
...
* ✅ Generate proper bcrypt hash for admin\_basic\_auth\_hash  
...
* [**DEPLOYMENT.md**](https://www.google.com/search?q=docs/DEPLOYMENT.md) \- Detailed deployment guide  
* [**CONFIGURATION.md**](https://www.google.com/search?q=docs/CONFIGURATION.md) \- Complete configuration reference  
* [**SECURITY.md**](https://www.google.com/search?q=docs/SECURITY.md) \- Security hardening and best practices  
* [**OPERATIONS.md**](https://www.google.com/search?q=docs/OPERATIONS.md) \- Day-to-day operations guide  
* [**BACKUP-RESTORE.md**](https://www.google.com/search?q=docs/BACKUP-RESTORE.md) \- Backup and recovery procedures  
* [**SCRIPTS.md**](https://www.google.com/search?q=docs/SCRIPTS.md) \- Script reference guide  
* [**TROUBLESHOOTING.md**](https://www.google.com/search?q=docs/TROUBLESHOOTING.md) \- Common issues and solutions  
* [**MIGRATION.md**](https://www.google.com/search?q=docs/MIGRATION.md) \- Migration from other setups  
* [**API.md**](https://www.google.com/search?q=docs/API.md) \- API usage and integration  
* [**ADVANCED-CUSTOMIZATION.md**](https://www.google.com/search?q=docs/ADVANCED-CUSTOMIZATION.md) \- Advanced customization options
