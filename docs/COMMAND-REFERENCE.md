...
```
docker.sh: could not auto-detect Compose project name; using default label. Set DOCKER_PROJECT_LABEL to override.
[06:02:28] [backup-run.sh] ERROR Unknown subcommand: '--help'
[06:02:28] [backup-run.sh] ERROR Valid subcommands: run [TYPE] | list | verify | rotate
[06:02:28] [backup-run.sh] ERROR Run './backup.sh help' for usage.
...
```
[06:02:28] [restore-run.sh] ERROR Unknown subcommand: '--help'
[06:02:28] [restore-run.sh] ERROR Valid subcommands: latest [TYPE] | list [--remote] | interactive
[06:02:28] [restore-run.sh] ERROR Run './restore.sh help' for usage.
