...
```
docker.sh: could not auto-detect Compose project name; using default label. Set DOCKER_PROJECT_LABEL to override.
[05:59:58] [backup-run.sh] ERROR Unknown subcommand: '--help'
[05:59:58] [backup-run.sh] ERROR Valid subcommands: run [TYPE] | list | verify | rotate
[05:59:58] [backup-run.sh] ERROR Run './backup.sh help' for usage.
...
```
[05:59:58] [restore-run.sh] ERROR Unknown subcommand: '--help'
[05:59:58] [restore-run.sh] ERROR Valid subcommands: latest [TYPE] | list [--remote] | interactive
[05:59:58] [restore-run.sh] ERROR Run './restore.sh help' for usage.
...
```
[1;31m Error:[0m This script must be run as root.
 Re-run with: [1msudo /tmp/workspace/killer23d/VaultWarden-OCI/dashboard.sh[0m
(--help not available or requires root)
```
