...
routing_prelude="$common_prelude; _email_driver_mailersend(){ TRACE+=\" api:\$1\"; return \"\${API_RC:-0}\"; }; _email_driver_sendgrid(){ TRACE+=\" sendgrid:\$1\"; return 0; }; _email_driver_mailgun(){ TRACE+=\" mailgun:\$1\"; return 0; }; _email_driver_postmark(){ TRACE+=\" postmark:\$1\"; return 0; }; _email_driver_resend(){ TRACE+=\" resend:\$1\"; return 0; }; _email_driver_cyberpersons(){ TRACE+=\" cyber:\$1\"; return 0; }; _smtp_upload_sidecar(){ TRACE+=\" sidecar\"; return \"\${SIDE_RC:-0}\"; }; _smtp_upload_direct(){ TRACE+=\" direct\"; [[ \"\${RESOLVE_MARK:-0}\" == 1 ]] && get_secret smtp_password >/dev/null; return \"\${DIRECT_RC:-0}\"; }; get_secret(){ TRACE+=\" secret:\$1\"; printf resolved-secret; }; reset_env"
