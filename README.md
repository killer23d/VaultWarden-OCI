...
**Edit `.env` first** — set non-secret email/runtime values, then configure Cloudflare CrowdSec secrets in the configured secrets file (`secrets/secrets.yaml` by default).
